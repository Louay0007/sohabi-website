...
export function SocialProof() {
  return (
    <section className="self-stretch py-16 flex flex-col justify-center items-center gap-6 overflow-hidden">
      <div className="text-center text-muted text-sm font-medium leading-tight">
        Designed for students, explorers, cafe regulars, and new-city friendships
      </div>
