...
const RealtimeCodingPreviews: React.FC = () => {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="SOHABI coffee invitation preview showing chat and plan confirmation"
    >
      ...
      >
        ...
        >
          ...
          >
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}>coffeeInvite = {"{"}</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> place: 'Cafe Atlas',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> time: 'Today 17:30',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}>
              {" "}
               vibe: 'quiet study table',
            </p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}> note: 'Want to grab coffee?'</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400, display: "block" }}>
              {" "}
