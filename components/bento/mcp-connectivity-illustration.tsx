...
const McpConnectivityIllustration: React.FC<McpConnectivityIllustrationProps> = ({ className = "" }) => {
  ...
  const integrations = [
    { name: "Cafe Atlas", icon: "/images/mcp-integrations/figma.svg", installed: true },
    { name: "Bookshop corner", icon: "/images/mcp-integrations/shadcn.svg" },
    { name: "Campus lawn", icon: "/images/mcp-integrations/nextjs.svg", installed: true },
    { name: "Quiet terrace", icon: "/images/mcp-integrations/tailwind-css.svg" },
    { name: "Sunset walk", icon: "/images/mcp-integrations/resend.svg", installed: true },
    { name: "Tea house", icon: "/images/mcp-integrations/react.svg" },
  ]
  ...
  return (
    <div
      ...
      role="img"
      aria-label="SOHABI nearby places list for coffee and friendship plans"
    >
      {/* Main Message Box */}
      <div
        style={{
