...
const AiCodeReviews: React.FC = () => {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="SOHABI match suggestion card with coffee plan button"
    >
      ...
      >
        ...
        >
          ...
          >
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}>friendMatch = {"{"}</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> name: 'Yasmine',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> shared: 'books + espresso',</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}>
              {"          plan: 'Coffee after class',"}
            </p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}> vibe: 'calm conversation'</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}>
      ...
      >
        ...
        >
          ...
          >
            ...
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}>{'                stroke="#2F312A"'}</p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}>
              {'                strokeLinecap="round"'}
            </p>
            <p style={{ margin: 0, whiteSpace: "pre-wrap", fontWeight: 400 }}>
