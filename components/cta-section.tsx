    ...
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-4xl md:text-5xl lg:text-[68px] font-medium leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[435px]">
            Your next friend might be one coffee away
          </h2>
          <p className="text-muted text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            Join SOHABI and start with something simple: a shared interest, a nearby cafe, a safe plan, and a conversation that can become friendship.
          </p>
        </div>
        <Link href="#pricing-section" >
          <Button
            className="px-[30px] py-2 bg-primary text-primary-foreground text-base font-medium leading-6 rounded-[99px] shadow-sm hover:bg-primary-dark transition-all duration-200"
            size="lg"
          >
            Join SOHABI
          </Button>
