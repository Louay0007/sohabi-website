  ...
  return (
    <section
      className="flex flex-col items-center text-center relative mx-auto rounded-2xl overflow-hidden my-6 py-0 px-4
         w-full min-h-[520px] h-[520px] md:w-[1220px] md:h-[600px] lg:h-[810px] md:px-0"
    >
      {/* SVG Background */}
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-28 md:mt-[120px] lg:mt-[160px] px-4">
        <h1 className="text-foreground text-[2.15rem] md:text-4xl lg:text-6xl font-medium leading-[0.98] md:leading-tight">
          Find your people over coffee
        </h1>
        <p className="text-muted-foreground text-[15px] md:text-base lg:text-lg font-medium leading-6 md:leading-relaxed max-w-[330px] md:max-w-lg mx-auto">
          SOHABI turns nearby matches into safe friendships, spontaneous cafe plans, and warm social moments that feel easy to say yes to.
        </p>
      </div>

      <Link href="#pricing-section" >
        <Button className="relative z-10 bg-secondary text-secondary-foreground hover:bg-secondary/90 px-7 py-3 rounded-full font-medium text-[15px] md:text-base shadow-lg ring-1 ring-white/10">
